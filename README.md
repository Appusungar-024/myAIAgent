...
|----------|----------|-------------|
| `MY_BOT_TOKEN` | ✅ | Bot token from Slack app (starts with `xoxb-`) |
| `MY_APP_TOKEN` | ✅ | App-level token for Socket Mode (starts with `xapp-`) |
| `MY_SIGNING_SECRET` | ✅ | Signing secret from Slack app |
